...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/components.css') }}">
    <script src="https://cdn.datatables.net/v/bs5/jq-3.7.0/dt-1.13.8/af-2.6.0/b-2.4.2/datatables.min.js"></script>
    <!-- Start GA -->
    <link href="https://cdn.datatables.net/v/bs5/jq-3.7.0/dt-1.13.8/af-2.6.0/b-2.4.2/datatables.min.css"
        rel="stylesheet">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class=active><a class="nav-link" href="{{ url('addcat') }}">Add Categories</a>
                                </li>
                                <li><a class="nav-link" href="{{ route('all.cat') }}">Manage Categories</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
                            <a href="#" class="nav-link has-dropdown"><i
                            ...
                            <ul class="dropdown-menu" data-toggle="dropdown">
                                <li class=active><a class="nav-link" href="{{ route('products.create') }}">Add
                                        Products</a>
                                </li>
