...
<tr>
<td></td>
<td><input type="submit" name="add_user" class="btn btn-primary btn-gradient btn-block w-100" value="Register As User" /></td>
</tr>
</table>
</form>
...
"fullname(db-field-name)" => $request['field-name'],
...
//put this code in Model to add default fillable
